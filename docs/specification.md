...
preview window の生成と生存管理を担当する coordinator。各ファイルを独立した window として開き、閉じた window の参照を解除する。既存の preview があれば AppKit の標準 tab group にまとめる。
